...
const settings_fixture = { tracked_arxiv_category_codes: ["cs.LG", "hep-ex", "physics"], papers_per_category_per_day: 10, interests_blurb_text: "world models", reading_intent_blurb_text: "", openrouter_api_key: "or_secret_key_material", airtable_personal_access_token: "pat_secret_key_material", airtable_base_input: "https://airtable.com/appExample123", openrouter_chat_model_id: "deepseek/deepseek-v4-flash" };
...
test("settings show a category tree, API connections, and a hard reset action", () => {
  ...
  assert.deepEqual(rows.filter((row) => row.type === "text_setting").map((row) => row.setting_key), ["interests_blurb_text", "reading_intent_blurb_text", "papers_per_category_per_day", "openrouter_api_key", "airtable_personal_access_token", "airtable_base_input"]);
