...
test("settings show a category tree, API connections, and a hard reset action", () => {
  ...
  assert.deepEqual(rows.filter((row) => row.type === "text_setting").map((row) => row.setting_key), ["interests_blurb_text", "reading_intent_blurb_text", "papers_per_category_per_day", "openrouter_api_key", "google_sheets_webhook_url"]);
